...
class bdApi_ControllerApi_Thread extends bdApi_ControllerApi_Abstract
{
    public function actionGetIndex()
    {
        ...
        $threadCreateDate = $this->_input->filterSingle('thread_create_date', XenForo_Input::UINT);
        ...
        switch ($order) {
            case 'thread_create_date':
                ...
                if ($threadCreateDate > 0) {
                    $conditions['post_date'] = array('>', $threadCreateDate);
                    $fetchOptions['page'] = 0;
                }
                break;
        ...
        if ($theForumId > 0 && $fetchOptions['page'] !== 0) {
