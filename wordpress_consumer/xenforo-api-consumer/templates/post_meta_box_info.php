		...
		<?php foreach ($records as $record): ?>
			<li>
				...
				<ul style="margin-left: 20px;">
					...
					<li>
						<label>
							<input type="checkbox" name="xfac_delete_sync[]" value="<?php echo $record->provider_content_id; ?>" />
			...
			<li>
				...
				<select name="xfac_forum_id">
					...
					<?php foreach ($meta['forums'] as $forum): ?>
						...
						<option value="<?php echo $forum['forum_id']; ?>"<?php if ($disabled) echo ' disabled="disabled"'; ?>>
							<?php echo $forum['forum_title']; ?>
						</option>
					<?php endforeach; ?>
				</select>
