...
<table id="xfac" class="form-table">
    <tr valign="top">
        ...
        <td>
            <input name="xfac_root" type="text" id="xfac_root" value="<?php echo esc_attr($config['root']); ?>"
                   class="regular-text"/>
        </td>
    </tr>
    <tr valign="top">
    ...
    <?php if (!empty($meta['linkIndex'])): ?>
        <tr valign="top">
            ...
            <td>
                ...
                <a href="<?php echo esc_attr($meta['linkIndex']); ?>"
                   target="_blank"><?php echo $meta['linkIndex']; ?></a>
