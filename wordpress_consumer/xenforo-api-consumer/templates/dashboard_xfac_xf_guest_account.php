...
<div class="wrap">
	<div id="icon-options-general" class="icon32">
		<br />
	</div><h2><?php _e('XenForo Guest Account', 'xenforo-api-consumer'); ?></h2>
	...
	<form method="post" action="options-general.php" id="xfacDashboardOptions">
		...
		<table class="form-table">
			<tr valign="top">
				<th scope="row"><label for="xfac_guest_username"><?php _e('Username', 'xenforo-api-consumer'); ?></label></th>
				<td>
					<input name="xfac_guest_username" type="text" id="xfac_guest_username" class="regular-text" />
				</td>
			</tr>
			<tr valign="top">
				<th scope="row"><label for="xfac_guest_password"><?php _e('Password', 'xenforo-api-consumer'); ?></label></th>
				<td>
